...
class TwoStageDetector_Triplet(BaseDetector, RPNTestMixin, BBoxTestMixin,
                               MaskTestMixin):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(TwoStageDetector_Triplet, self).__init__()
        ...
        # embedding_head used to output embedded roi feature
        if embedding_head is not None:
            self.embedding_head = builder.build_head(embedding_head)
    ...
    def init_weights(self, pretrained=None):
        super(TwoStageDetector_Triplet, self).init_weights(pretrained)
    ...
    def forward_train_triplet(self,
                              img_,
                              img_meta_,
                              gt_bboxes_,
                              gt_labels_,
    ...
    def forward_train(self,
                      ...
                      gt_masks=None,
                      proposals=None):
        return self.forward_train_triplet(img,
                                          img_meta,
                                          gt_bboxes,
                                          gt_labels,
